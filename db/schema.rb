...
ActiveRecord::Schema.define(version: 20171127132441) do
  ...
  create_table "auth_user_roles", id: :integer, default: nil, force: :cascade do |t|
  ...
  create_table "auth_users", id: :integer, default: nil, force: :cascade do |t|
  ...
  create_table "components", id: :integer, default: nil, force: :cascade do |t|
    t.string "name", limit: 255
    t.string "code", limit: 255
  ...
  create_table "licences", id: :integer, default: nil, force: :cascade do |t|
    t.integer "name"
    t.date "end_time"
  end
  ...
  create_table "order_change_status_history", id: :integer, default: nil, force: :cascade do |t|
    t.integer "order_id"
    t.integer "status_transition_id"
    t.datetime "change_time"
  end

  create_table "order_priorities", id: :integer, default: nil, force: :cascade do |t|
    t.string "name", limit: 255
  ...
  create_table "privileges", id: :integer, default: nil, force: :cascade do |t|
    t.string "name", limit: 255
    t.string "code", limit: 255
  ...
  create_table "status_transitions", id: :integer, default: nil, force: :cascade do |t|
    t.integer "status_from_id"
    t.integer "status_to_id"
  end

  create_table "statuses", id: :integer, default: nil, force: :cascade do |t|
    t.string "name", limit: 255
    t.string "code", limit: 255
  end

  create_table "vehicles", id: :integer, default: nil, force: :cascade do |t|
  ...
  create_table "ware_types", id: :integer, default: nil, force: :cascade do |t|
    t.string "name", limit: 255
  ...
  create_table "wares", id: :integer, default: nil, force: :cascade do |t|
